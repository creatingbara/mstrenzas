...
import { getServices, getStaffMember } from "@/lib/local-db";

export const dynamic = "force-dynamic";
export const runtime = "nodejs";

export const metadata = {
  title: "Servicios del miembro | Panel M&S Trenzas"
};

export default async function TeamMemberServicesPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  await requireAdminPageAccess(`/admin/equipo/${id}/servicios`, { adminOnly: true });
    ...
    <section className="grid gap-5">
      <div className="flex flex-col justify-between gap-3 md:flex-row md:items-end">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-black text-ink md:text-4xl">Servicios asignados</h2>
